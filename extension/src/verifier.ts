...
export async function verifyRelease(
  ...
  try {
    ...
    try {
      console.log("START: async bundle verification");
      ...
      console.log("END: async bundle verification");
    } catch (sigstoreErr: any) {
      console.error("Sigstore verification failed:", sigstoreErr.message);
      if (sigstoreErr.cause) {
        console.error("Sigstore verification CAUSE:", sigstoreErr.cause);
      }
      return 'INVALID';
    }
